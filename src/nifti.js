...
nifti.NIFTI2 = nifti.NIFTI2 || require('./nifti2.js');
...
nifti.isNIFTI1 = function (data) {
  ...
  return !!(
    mag1 === nifti.NIFTI1.MAGIC_NUMBER[0] &&
    mag2 === nifti.NIFTI1.MAGIC_NUMBER[1] &&
...
nifti.isNIFTI2 = function (data) {
  ...
  return !!(
    mag1 === nifti.NIFTI2.MAGIC_NUMBER[0] &&
    mag2 === nifti.NIFTI2.MAGIC_NUMBER[1] &&
