...
var nifti = nifti || {};
nifti.Utils = nifti.Utils || require('./utilities.js');
nifti.NIFTI1 = nifti.NIFTI1 || require('./nifti1.js');
...
nifti.NIFTI2.prototype.readHeader = function (data) {
  ...
  for (ctr = 0; ctr < 8; ctr += 1) {
    index = 104 + ctr * 8;
    this.pixDims[ctr] = nifti.Utils.getDoubleAt(
      rawData,
      index,
      this.littleEndian,
    );
  ...
  this.slice_duration = nifti.Utils.getDoubleAt(
    rawData,
    208,
    this.littleEndian,
  );
  ...
  for (ctrOut = 0; ctrOut < 3; ctrOut += 1) {
    for (ctrIn = 0; ctrIn < 4; ctrIn += 1) {
      ...
      this.affine[ctrOut][ctrIn] = nifti.Utils.getDoubleAt(
        rawData,
        index,
        this.littleEndian,
      );
...
nifti.NIFTI2.prototype.toFormattedString = function () {
  ...
  string +=
    ...
    this.xyzt_units +
    ' (' +
    this.getUnitsCodeString(nifti.NIFTI1.SPATIAL_UNITS_MASK & this.xyzt_units) +
    ', ' +
 ...
 * @returns {number}
 */
nifti.NIFTI2.prototype.getExtensionSize =
  nifti.NIFTI1.prototype.getExtensionSize;
 ...
 * @returns {number}
 */
nifti.NIFTI2.prototype.getExtensionCode =
  nifti.NIFTI1.prototype.getExtensionCode;
 ...
 * @returns {string}
 */
nifti.NIFTI2.prototype.getDatatypeCodeString =
  nifti.NIFTI1.prototype.getDatatypeCodeString;
 ...
 * @returns {string}
 */
nifti.NIFTI2.prototype.getTransformCodeString =
  nifti.NIFTI1.prototype.getTransformCodeString;
 ...
 * @returns {string}
 */
nifti.NIFTI2.prototype.getUnitsCodeString =
  nifti.NIFTI1.prototype.getUnitsCodeString;
 ...
 * @returns {Array.<Array.<number>>}
 */
nifti.NIFTI2.prototype.convertNiftiQFormToNiftiSForm =
  nifti.NIFTI1.prototype.convertNiftiQFormToNiftiSForm;
 ...
 * @returns {string}
 */
nifti.NIFTI2.prototype.convertNiftiSFormToNEMA =
...
nifti.NIFTI2.prototype.nifti_mat33_determ =
  nifti.NIFTI1.prototype.nifti_mat33_determ;
